    ...
    <div className="h-screen flex flex-col justify-center items-center bg-white ">
      ...
      <div className="flex flex-row gap-6 justify-center items-center">
        <div className=" h-80 w-80 flex flex-col  justify-center items-center gap-3">
          <div className="text-9xl"><RiCalendarScheduleFill /></div>
          <h1 className="font-bold text-2xl">Make Schedule</h1>
          <p className="p-3">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
        </div>
        <div className=" h-80 w-80 flex flex-col justify-center items-center gap-3">
          <div className="text-9xl"><GrSchedulePlay /></div>
          
          <h1 className="font-bold text-2xl">Start Discussion</h1>
          <p className="p-3">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
          </div>
        <div className=" h-80 w-80 flex flex-col justify-center items-center gap-3" >
          <div className="text-9xl"><SiApachedolphinscheduler /></div>
